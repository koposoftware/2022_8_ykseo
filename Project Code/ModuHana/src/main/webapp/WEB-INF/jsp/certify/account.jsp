			...
			<div class="container" data-aos="fade-up" data-aos-delay="100">
				<div class="row justify-content-center">
					<div class="col-lg-6 mt-5">
						...
						<form class="idcard-form"  method="post" action="${ path }/certify/account/create" 
							...
							<div class="row gy-4 mt-3">
								<div class="col-lg-6 form-group">
									<input type="password" class="form-control" name="password" placeholder="예치금 계좌 비밀번호 4자리" required/> 
								</div>
								<div class="col-lg-6 form-group">
									<input type="password" class="form-control" name="repassword" placeholder="예치금 계좌 비밀번호 재입력" required/> 
								</div>
								
								<div class="text-center">
									<button name="idcardSubmitBtn" type="submit"> Submit </button>
								</div>
							</div>
						</form>
