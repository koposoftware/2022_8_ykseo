					...
					<div class="col-lg-6 mt-5">
						...
						<div class="idcard-form text-center" >
							<div class="text-center">
								<img style="width:50%" alt="계좌 생성 이미지" src="${ path }/resources/assets/img/fund/growing.gif">
							</div>
							<h3>투자가 완료되었습니다.</h3>
							<div class="row gy-4 mt-3">
								<div class="col-lg-6 text-center">
									<button onclick= "location.href = '${path}/project/list'"> 다른 투자하기 </button>
								</div>
								<div class="col-lg-6 text-center">
									<button onclick= "location.href = '${path}/fund/detail/${ fundSeq }'"> 투자내역 보기 </button>
								</div>
							</div>
						</div>
